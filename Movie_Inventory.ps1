...
Send-MailMessage -SMTPServer ESXi-WinMail -To @("varunmaster95@gmail.com","nvelani2@gmail.com","s.advani96@gmail.com") -From esxiplex@gmail.com -Subject "Plex Movie List - $date" -Body "$body" -BodyAsHtml
