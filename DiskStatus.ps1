...
Send-MailMessage -SMTPServer localhost -To @("varunmaster95@gmail.com","nvelani2@gmail.com") -From Plex@ESXI-Plex.com -Subject "Plex Disk Usage - $(Get-Date -Format G)" -Body "$body" -BodyAsHtml
